...
-   pop_jan_total: 총인구수(1월 1일 기준, 단위: 1,000명)

-   pop_jul_total: 총인구수(7월 1일 기준, 단위: 1,000명)

-   pop_jul_male: 남성 총인구(7월 1일 기준, 단위: 1,000명)

-   pop_jul_femal: 남성 총인구(7월 1일 기준, 단위: 1,000명)
...
-   natural_change: 자연변화수(출생아수 - 사망자수, 단위: 1,000명)
...
-   deaths_total: 사망자수(단위: 1,000명)

-   deaths_male: 남성 사망자수(단위: 1,000명)

-   deaths_female: 여성 사망자수(단위: 1,000명)
...
-   net_migrants: 순이동자(전입자 - 전출자, 단위: 1,000명)
