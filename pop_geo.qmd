...
leaflet() |> 
  addTiles() |> 
  addPopups(126.997839, 37.470810, "서울특별시교육청\n교육연수원",
...
왼편 지도에서 시군구 하나를 클릭하면 2015\~2022년의 추이를 볼 수 있습니다. 오픈 API를 통해 KOSIS(<https://kosis.kr/index/index.do>) 데이터를 가져와 그래프를 그리기 때문에 시간이 지체될 수 있습니다.
